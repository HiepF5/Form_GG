...
function renderAnswerOption(question, index) {
  ...
  return `
      <br>
      ${htmlArr.join("")}
      <button id="buttonAddQuestion-${index}" class="buttonAddQuestion fa-solid fa-circle-plus" onclick="addOption()"></button>
      <br>
      `;
}
...
function renderAnswer(question, index) {
  switch (question.type) {
    case TYPE_INPUT:
      ...
      <input  class="inputcss"  type="text" name="question_input" placeholder="Enter" />
      `;
    case TYPE_PARAGRAPH:
      return `
      <textarea  class="inputcss"  type="text" name="question_textarea" placeholder="Enter"></textarea>`;
    case TYPE_RADIO:
